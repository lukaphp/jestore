package it.computerproject.jestore.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("JeStore");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("JeStore");
        ...
        config.getMapConfigs().put("it.computerproject.jestore.domain.*", initializeDomainMapConfig(jHipsterProperties));
